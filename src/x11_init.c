...
static GLFWbool initExtensions(void)
{
    ...
    _glfw.x11.vidmode.handle = _glfwPlatformLoadModule("libXxf86vm.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xi.handle = _glfwPlatformLoadModule("libXi.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.randr.handle = _glfwPlatformLoadModule("libXrandr.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xcursor.handle = _glfwPlatformLoadModule("libXcursor.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xinerama.handle = _glfwPlatformLoadModule("libXinerama.dylib");
#else
...
#elif defined(__APPLE__)
        _glfw.x11.x11xcb.handle = _glfwPlatformLoadModule("libX11-xcb.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xrender.handle = _glfwPlatformLoadModule("libXrender.dylib");
#else
...
#elif defined(__APPLE__)
    _glfw.x11.xshape.handle = _glfwPlatformLoadModule("libXext.dylib");
#else
...
#elif defined(__APPLE__)
    void* module = _glfwPlatformLoadModule("libX11.dylib");
#else
